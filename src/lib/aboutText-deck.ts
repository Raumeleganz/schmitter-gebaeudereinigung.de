...
export const aboutTextVariants = (city: string): string[] => [
  ...
  `In ${city} bietet Schmitter als etabliertes Reinigungsunternehmen maßgeschneiderte Lösungen für Ihre individuellen Anforderungen. Mit über 15 Jahren Erfahrung verstehen wir die vielfältigen Herausforderungen der Gebäudereinigung in ${city}. Unsere geschulten Fachkräfte arbeiten mit modernster Technik und umweltschonenden Reinigungsmitteln, um optimale Ergebnisse zu erzielen. Von der täglichen Unterhaltsreinigung über Grundreinigungen bis hin zu Spezialreinigungen – wir passen unsere Dienstleistungen exakt an Ihre Bedürfnisse an. Vertrauen Sie auf Qualität, Erfahrung und einen Service, der Ihre Erwartungen in ${city} übertrifft.`,

  // Variante 4: Nachhaltigkeit & Effizienz
  `Schmitter verbindet in ${city} professionelle Gebäudereinigung mit ökologischer Verantwortung. Als umweltbewusster Dienstleister setzen wir auf ressourcenschonende Reinigungsmethoden und biologisch abbaubare Reinigungsmittel – ohne Kompromisse bei der Hygiene. In ${city} mit seiner dynamischen Entwicklung benötigen Unternehmen effiziente Reinigungslösungen, die Zeit und Kosten sparen. Unser geschultes Personal arbeitet nach strukturierten Prozessen und garantiert konstante Qualität. Von Büros über Praxen bis hin zu Industrieanlagen: Schmitter ist Ihr Partner für nachhaltige Sauberkeit und dokumentierte Ergebnisse in ${city}.`,

  // Variante 5: Schnelligkeit & Verfügbarkeit
  `Schneller Start, verlässliche Qualität – Schmitter macht Gebäudereinigung in ${city} einfach. Mit kurzen Reaktionszeiten, transparenten Festpreisen und flexiblen Einsatzzeiten sind wir der ideale Partner für Unternehmen in ${city}. Unsere erfahrenen Reinigungskräfte kennen die lokalen Anforderungen und arbeiten diskret sowie effizient. Ob regelmäßige Unterhaltsreinigung, einmalige Grundreinigung oder Sonderreinigungen – wir bieten das komplette Leistungsspektrum aus einer Hand. Profitieren Sie von über 15 Jahren Expertise, modernster Reinigungstechnik und einem Service, der Ihre Erwartungen in ${city} übertrifft.`,

  // Variante 6: Hygiene & Gesundheit
  `In ${city} sorgt Schmitter für höchste Hygienestandards in Ihren Räumlichkeiten. Als spezialisierter Dienstleister für Gebäudereinigung legen wir besonderen Wert auf gesundheitsfördernde Reinigungskonzepte. Unsere zertifizierten Fachkräfte arbeiten nach aktuellen Hygienerichtlinien und setzen professionelle Reinigungstechnik ein, die Bakterien, Viren und Allergene wirkungsvoll beseitigt. Besonders für medizinische Einrichtungen, Praxen und lebensmittelverarbeitende Betriebe in ${city} bieten wir spezielle Hygienekonzepte. Mit Schmitter investieren Sie in die Gesundheit Ihrer Mitarbeiter und Kunden – verlässlich, dokumentiert und nach höchsten Standards in ${city}.`,

  // Variante 7: Zuverlässigkeit & Planbarkeit
  `Planbare Sauberkeit in ${city} – darauf können Sie sich bei Schmitter verlassen. Als professioneller Dienstleister für Gebäudereinigung garantieren wir feste Ansprechpartner, definierte Leistungsverzeichnisse und termingerechte Ausführung. In ${city} vertrauen zahlreiche Unternehmen auf unsere strukturierten Abläufe und konstante Qualität. Unsere geschulten Reinigungskräfte arbeiten nach Checklisten, dokumentieren ihre Leistungen und unterliegen regelmäßigen Qualitätskontrollen. Von der ersten Besichtigung über das Festpreis-Angebot bis zur laufenden Betreuung – Schmitter steht für Transparenz, Zuverlässigkeit und professionelle Gebäudereinigung in ${city}.`,

  // Variante 8: Wirtschaftlichkeit & Wert
  `Mehr Leistung fürs Budget – Schmitter bietet in ${city} effiziente Gebäudereinigung zu fairen Konditionen. Durch optimierte Prozesse, geschultes Personal und moderne Reinigungstechnik halten wir die Kosten niedrig, ohne an der Qualität zu sparen. In ${city} mit seinen vielfältigen Wirtschaftsbranchen verstehen wir die Bedeutung eines ausgezeichneten Preis-Leistungs-Verhältnisses. Unsere transparenten Festpreise, kurzen Angebotszeiten und flexiblen Vertragsmodelle machen Gebäudereinigung kalkulierbar. Ob Büro, Praxis oder Industrieanlage – mit Schmitter erhalten Sie messbare Qualität, dokumentierte Leistungen und einen Service, der sich rechnet in ${city}.`,
];
 ...
 * // → "Schmitter ist seit über 15 Jahren Ihr zuverlässiger Partner..."
 */
