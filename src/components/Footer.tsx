...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    company: [
      ...
      { name: "Preiskalkulator", href: "/preiskalkulator" },
      { name: "FAQ", href: "/faq" },
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link href="/" className="inline-block group">
              <div className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400 mb-4 group-hover:from-blue-300 group-hover:to-indigo-300 transition-all duration-300">
                Schmitter
              </div>
            </Link>
            <p className="text-gray-400 leading-relaxed mb-6">
              Gebäudereinigung in NRW, die verständlich bleibt: feste Ansagen, keine Märchenstunden, dafür gute Arbeit und Leute, die zurückschreiben, wenn sie müssen.
            </p>
          ...
          {/* Services Links */}
          <div>
            <h4 className="font-bold text-lg mb-6 text-white">Unsere Leistungen</h4>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <button 
                  ...
                  className="text-gray-400 hover:text-blue-400 transition-colors duration-300 flex items-center group text-left"
                >
                  <svg className="w-4 h-4 mr-2 text-blue-500 opacity-0 group-hover:opacity-100 transform -translate-x-2 group-hover:translate-x-0 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2025 Schmitter Gebäudereinigung. Alle Rechte vorbehalten.
            </p>
